    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-6">
          ...
          <div className="mb-6">
            <h1 className="text-3xl font-heading font-bold text-gray-900">Staff Settings</h1>
            ...
            <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start">
                      ...
                      <div className="ml-3 text-sm">
                        <label htmlFor="application-assignments" className="font-medium text-gray-700">
                          Application Assignments
                        </label>
                        <p className="text-gray-500">New applications assigned to you</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-3 text-sm">
                        ...
                        <p className="text-gray-500">Important system announcements</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-3 text-sm">
                        <label htmlFor="performance-reports" className="font-medium text-gray-700">
                          Performance Reports
                        </label>
                        <p className="text-gray-500">Weekly performance summaries</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <Card title="Work Preferences">
                <div className="space-y-4">
                  ...
                  <div>
                    <label htmlFor="max-applications" className="block text-sm font-medium text-gray-700 mb-1">
