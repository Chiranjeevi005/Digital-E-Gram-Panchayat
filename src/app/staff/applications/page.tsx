    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-6">
          ...
          <div className="mb-6">
            <h1 className="text-3xl font-heading font-bold text-gray-900">Assigned Applications</h1>
            <p className="text-gray-600 mt-2">Manage applications assigned to you</p>
          </div>
          
          <Card>
            <div className="mb-6">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <h2 className="text-xl font-heading font-semibold text-gray-900">Application Queue</h2>
